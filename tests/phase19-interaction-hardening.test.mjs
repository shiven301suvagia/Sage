...
test('Phase 19: renderer keeps a controlled character-state map',async()=>{const source=await read('app/renderer/app.mjs');assert.match(source,/CHARACTER_STATES=new Set/);assert.match(source,/CHARACTER_STATES\.has/);});
