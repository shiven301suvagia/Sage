...
export class ProactiveEngine{
 constructor({experience,reminders,context=null,onSuggestion=()=>{},cooldown=DEFAULT_COOLDOWN,contextCooldown=CONTEXT_COOLDOWN,presence=null}={}){this.experience=experience;this.reminders=reminders;this.context=context;this.onSuggestion=onSuggestion;this.cooldown=cooldown;this.contextCooldown=contextCooldown;this.lastSuggestionAt=0;this.lastContextSuggestionAt=0;this.lastContextKey=null;this.timer=null;this.presence=presence||new CompanionPresence({focusCooldown:contextCooldown});}
