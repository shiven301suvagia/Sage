...
export class CharacterRuntime{
 #state;#listeners=new Set();#sleepTimer=null;
 ...
 wake(){if(this.#state==='dormant'||this.#state==='sleeping'){this.transition('awakening');this.transition('idle');return true;}return this.#state!=='dormant';}
 beginThinking(){return this.#state==='idle'&&this.transition('thinking');}
 beginSpeaking(){return (this.#state==='thinking'||this.#state==='working'||this.#state==='idle')&&this.transition('speaking');}
 beginWorking(){return (this.#state==='thinking'||this.#state==='idle')&&this.transition('working');}
